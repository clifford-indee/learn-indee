...
class AdminScreenerPage(BasePage):
    ...
    def search_project(self, project: str):
        ...
        try:
            ...
            log.logger.exception("Failed to search project in page.")
    ...
    def click_on_project(self):
        try:
            ...
            log.logger.exception("Failed to click on the project.")
    ...
    def navigate_to_send_screen(self):
        ...
        try:
            ...
            log.logger.exception("Navigation to screener failed.")
    ...
    def fill_screeners(self, views, security="None", watermarktype="None"):
        try:
            ...
            log.logger.exception("Fail to fill screeners fields.")
        else:
            # watermark type
    ...
    def click_continue_button(self):
        try:
            ...
            log.logger.exception("Failed to click continue button.")
            assert False, "Failed to click continue button."
    ...
    def fill_recipient(self, email, watermark: str, name):
        ...
        try:
            ...
            log.logger.exception("Failed to fill recipient fields.")
    ...
    def click_send_email(self):
        try:
            ...
            log.logger.exception("Failed to click send email button.")
            assert False, "Failed to click send email button."
    ...
    def verify_send_screener(self):
        ...
        try:
            ...
            log.logger.exception("Failed to verify screeners sent.")
